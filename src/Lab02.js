...
class Lab02 extends React.Component {
  render() {
    return (
      beastArray.map(animal => {
        return <HornedBeast title={animal.title} image_src={animal.image_url} image_title={animal.title} image_alt={animal.description} description={animal.description} />
      })
    )
  }
}
